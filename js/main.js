// import './util.js';
// import './data.js';
// // import { getRandomArbitrary, getRandomIntInclusive } from './util.js';
// import { CHECKOUT, CHEKIN, TYPE } from './data.js';
// //author
...
const unicFeature = () => {
 ...
 return {
    ...
    features: Array.from({length: _.random(1, features.length)}, unicFeature),
    description: randomArrayElem(DESCRIPTION),
    photos: Array.from({length: _.random(1, PHOTOS.length)}, unicFeature),
   };

  };

 const properties = Array.from({length: 10}, createProperty);
